...
import { fetchPosts, fetchTags, sortPosts } from "../redux/slices/posts.js";
import { fetchComments } from "../redux/slices/comments.js";

export const Home = () => {
  const sortValues = ["Новые", "Популярные"];
    ...
    <>
      ...
      >
        {sortValues.map((value, index) => (
          <Tab onClick={() => sortHandle(index)} key={value} label={value} />
        ))}
      </Tabs>
